...
export default function SteampunkCursor() {
  ...
  useEffect(() => {
    const handlePointerMove = (e) => {
      ...
      // Spawn golden steam / aether motes on movement
      ...
      if (dist > 3 && sparksRef.current.length < SPARK_MAX) {
        sparksRef.current.push({
          ...
          vy: -p.vy * 0.08 + (Math.random() - 0.5) * 1.2 - 0.3,
          size: 1.2 + Math.random() * 2.2,
          alpha: 0.85,
          decay: 0.035 + Math.random() * 0.03,
          color: Math.random() > 0.4 ? '#f59e0b' : Math.random() > 0.5 ? '#fde047' : '#d97706',
        });
      }
    ...
    const handleMouseDown = (e) => {
      ...
      // Burst of golden sparks on click
      for (let i = 0; i < 8; i++) {
  ...
  useEffect(() => {
    ...
    const tick = () => {
      ...
      const spinSpeed = (isHovered || isCardHovered ? 4.5 : 0.8) + p.speed * 0.75;
  ...
  return (
    <>
      ...
      {/* Main Golden Steampunk Pointer Arrow */}
      <div
        ref={cursorRootRef}
      ...
      >
        <div
          style={{
            ...
            transform: `scale(${isClicking ? 0.92 : isHovered ? 1.12 : 1.0})`,
            transition: 'transform 0.14s cubic-bezier(0.16, 1, 0.3, 1)',
            filter: isHovered
              ? 'drop-shadow(0 0 6px rgba(245, 158, 11, 0.85)) drop-shadow(0 2px 5px rgba(42, 24, 11, 0.45))'
              : 'drop-shadow(0 2px 6px rgba(42, 24, 11, 0.45))',
          }}
        >
          <svg
            width="26"
          ...
          >
            <defs>
              {/* Radiant 24k Gold Highlight Gradient */}
              ...
              {/* Antique Burnished Brass Shadow Gradient */}
              <linearGradient id="brassDarkFacet" x1="0%" y1="0%" x2="100%" y2="100%">
                <stop offset="0%" stopColor="#d49a2a" />
                <stop offset="45%" stopColor="#9a6218" />
                <stop offset="85%" stopColor="#6e3e0c" />
                <stop offset="100%" stopColor="#452306" />
              </linearGradient>

              {/* Micro Brass Cog Gradient */}
              <linearGradient id="cogBrassGrad" x1="0%" y1="0%" x2="100%" y2="100%">
                <stop offset="0%" stopColor="#ffea75" />
                <stop offset="50%" stopColor="#d9931a" />
                <stop offset="100%" stopColor="#7a4409" />
              </linearGradient>

              {/* Ruby / Amber Axle Jewel Gradient */}
            ...
            {/* ── 1. Outer Deep Bronze Cast Shadow & Bevel Edge ── */}
            <path
            ...
            {/* ── 2. Dark Antique Brass Right/Lower Facet & Shaft ── */}
            <path
              d="M 0 0 L 6 12 L 8 13.5 L 14.5 13.5 L 8 13.5 L 12 21.5 L 8.5 23 L 4.5 15 L 6 12 Z"
              fill="url(#brassDarkFacet)"
            />

            {/* ── 3. Luminous 24k Gold Left/Upper Facet (Catches Overhead Light) ── */}
            <path
              d="M 0 0 L 0 19 L 4.5 15 L 6 12 Z"
              fill="url(#goldLightFacet)"
            />

            {/* ── 4. Chiseled Center Blade Ridge Line ── */}
            <line
              x1="0"
              y1="0"
              x2="6"
            ...
            {/* ── 6. Precision Vernier Ticks along Left Edge ── */}
            <line x1="0.5" y1="4.5" x2="2.2" y2="4.5" stroke="#452306" strokeWidth="0.55" />
            <line x1="0.5" y1="8" x2="3.0" y2="8" stroke="#452306" strokeWidth="0.65" />
            <line x1="0.5" y1="11.5" x2="2.2" y2="11.5" stroke="#452306" strokeWidth="0.55" />
            <line x1="0.5" y1="15" x2="3.0" y2="15" stroke="#452306" strokeWidth="0.65" />
            ...
            >
              <circle cx="8.2" cy="17.5" r="2.2" fill="url(#cogBrassGrad)" stroke="#261408" strokeWidth="0.4" />
              {/* 4 Micro Teeth */}
              <line x1="8.2" y1="14.8" x2="8.2" y2="20.2" stroke="#ffea75" strokeWidth="0.75" />
              <line x1="5.5" y1="17.5" x2="10.9" y2="17.5" stroke="#ffea75" strokeWidth="0.75" />
              <circle cx="8.2" cy="17.5" r="0.8" fill="#452306" />
            </g>
            ...
            >
              {/* Outer Gear Wheel */}
              <circle cx="5.6" cy="9.2" r="3.4" fill="url(#cogBrassGrad)" stroke="#1a0e06" strokeWidth="0.45" />
              
              {/* 6 Radial Brass Gear Teeth */}
              <line x1="5.6" y1="5.2" x2="5.6" y2="13.2" stroke="#ffe575" strokeWidth="1.0" />
              <line x1="2.1" y1="7.2" x2="9.1" y2="11.2" stroke="#ffe575" strokeWidth="1.0" />
              <line x1="2.1" y1="11.2" x2="9.1" y2="7.2" stroke="#ffe575" strokeWidth="1.0" />

              {/* Inner Gear Recess */}
              <circle cx="5.6" cy="9.2" r="2.2" fill="#5c340b" stroke="#ffd700" strokeWidth="0.3" />

              {/* Center Ruby / Amber Pivot Jewel */}
              <circle cx="5.6" cy="9.2" r="1.2" fill="url(#rubyJewelGrad)" stroke="#ffd700" strokeWidth="0.3" />
            ...
            <g transform="translate(2.4, 15.6)">
              <circle cx="0" cy="0" r="0.85" fill="#fde047" stroke="#452306" strokeWidth="0.35" />
              <line x1="-0.5" y1="0" x2="0.5" y2="0" stroke="#452306" strokeWidth="0.3" />
            </g>
            {/* Rivet 2: Shaft tail */}
            <g transform="translate(9.8, 20.8)">
              <circle cx="0" cy="0" r="0.8" fill="#fde047" stroke="#452306" strokeWidth="0.35" />
              <line x1="-0.45" y1="0" x2="0.45" y2="0" stroke="#452306" strokeWidth="0.3" />
            </g>
            {/* Rivet 3: Right wing */}
            ...
            {/* ── 10. Fine Gold Apex Pip (Hot Spot 0, 0) ── */}
            <circle cx="0" cy="0" r="0.85" fill="#fffbe8" stroke="#180b04" strokeWidth="0.3" />
          </svg>
        </div>
      </div>
    </>
